...
class MatriculasFormList extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $cadPessoas_id = new TEntry('cadPessoas_id');
        ...
        $this->form->addQuickField('Cadpessoas Id', $cadPessoas_id,  100 );
        ...
        $column_cadPessoas_id = new TDataGridColumn('cadPessoas_id', 'Cadpessoas Id', 'left');
