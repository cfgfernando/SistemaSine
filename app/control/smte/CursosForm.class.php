...
class CursosForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_Cursos');
        ...
        $this->form->addQuickField('Requisito:', $requisito,  300 );
        $this->form->addQuickField('Carga Horária:', $carga_horaria,  100 );
