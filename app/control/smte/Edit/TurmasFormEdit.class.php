 ...
 */
class TurmasFormEdit extends TWindow
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form->addQuickField('Nome Turma', $nome_turma,  200 );
        $this->form->addQuickField('Cursos', $cursos_id, 200 );
        $this->form->addQuickField('Agente Qualificador Idagente', $agente_qualificador_idagente,  200 );
        $this->form->addQuickField('Data Inicio', $data_inicio,  100 );
        $this->form->addQuickField('Data Final', $data_final,  100 );
        $this->form->addQuickField('Minimo Alunos', $minimo_alunos,  60 );
        $this->form->addQuickField('Status', $status,  120 );
        
        
        //$cursos_id->setEditable(FALSE);
        //$agente_qualificador_idagente->setEditable(FALSE);
