<?php
/**
 * MatriculasFormList Form List
 * @author  <your name here>
 */
class MatriculasFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $id = new TEntry('id');
        $turmas_id = new TEntry('turmas_id');
        $candidato_id = new TEntry('candidato_id');
        $data_inscricao = new TDate('data_inscricao');


        // add the fields
        $this->form->addQuickField('Id', $id,  100 );
        $this->form->addQuickField('Turmas Id', $turmas_id,  100 );
        $this->form->addQuickField('Candidato Id', $candidato_id,  100 );
        ...
        $column_turmas_id = new TDataGridColumn('turmas_id', 'Turmas Id', 'left');
        $column_candidato_id = new TDataGridColumn('candidato_id', 'Candidato Id', 'left');
        $column_data_inscricao = new TDataGridColumn('data_inscricao', 'Data Inscricao', 'left');


        // add the columns to the DataGrid
        $this->datagrid->addColumn($column_id);
        $this->datagrid->addColumn($column_turmas_id);
        $this->datagrid->addColumn($column_candidato_id);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            if (TSession::getValue('Matriculas_filter'))
            {
                // add the filter stored in the session to the criteria
                $criteria->add(TSession::getValue('Matriculas_filter'));
            }
