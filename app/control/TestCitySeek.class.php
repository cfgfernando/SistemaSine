...
class TestCitySeek extends TWindow
{
    ...
    public function __construct()
    {
        ...
        $this->datagrid->enablePopover('Title', 'Nome {nome}');
        ...
        $this->datagrid->addQuickAction('Select', new TDataGridAction(array($this, 'onSelect')), 'nome', 'ico_apply.png');
